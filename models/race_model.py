...
def create_default_races(db):
    ...
    },
    {
        ...
        "resumo": "Criaturas de aparência infernal, herdadas de antepassados que ousaram fazer pactos com diabos para se tornarem mais poderosos. Todo Tiefling carrega essa maldição e esse poder, desde cedo aprende a viver à margem da sociedade e esconder sua aparência."
    },
    {
        "name": "Halfling", 
        "hp_bonus": 0, 
